...
WebElement goneText=wait.until(ExpectedConditions.presenceOfElementLocated(By.id("massage")));
String text=goneText.getText();
System.out.println(text);

driver.findElement(By.xpath("//button@onclick='swapCheck()']")).click();
WebElement itsBack=wait.until(ExpectedConditions.presenceOfElementLocated(By.id("massage")));
