...
public class MoreStringFunction {
	...
	public static void main(String[] args) {
		...
		//if it finds matching char sequence --> then replaceme=me.replace("good", "great");
		System.out.println(me);
		//if it is not finding matching sequence --> not replaceme=me.replace("Great", "Awesome");
		System.out.println(me);
