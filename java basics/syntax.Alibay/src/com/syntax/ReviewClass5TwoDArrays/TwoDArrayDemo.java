package com.syntax.ReviewClass5TwoDArrays;
...
public static void main(String[] args) {
	...
	System.out.println("Thrid element in second "+numbers[1][2]);
	
	//initialize some value for second row=row index 1
	numbers[1][0]=9;
	numbers[1][1]=6;
	numbers[1][2]=2;
	numbers[1][3]=8;
	...
	//Initialize values for third row=row index 2
	numbers[2][0]=3;
	numbers[2][1]=0;
	numbers[2][2]=8;
	numbers[2][3]=5;
	//2 way
	int[][] numbers2= { {7,1,6,12}, {9,6,2,8,1,4},  {3,0,8,5}};
	
	//Print fourth element in first row
	...
	System.out.println("row= "+length0+" "+"row1= "+length1+ " row2= " +length2);
	
	//3 way,the coolest way:)
