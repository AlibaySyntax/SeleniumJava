...
String expected1=fname+" "+mname+" "+lname;
...
addEmp.createEmpLoginCR(ConfigsReader.getProperty("empUserName"),ConfigsReader.getProperty("empPassword"));	
}
}
