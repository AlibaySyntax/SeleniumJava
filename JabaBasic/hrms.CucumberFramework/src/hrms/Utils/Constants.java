...
public class Constants extends BaseClass {
	...
	public static final String TESTDATA_FILEPATH=System.getProperty("user.dir")+"/src/test/resources/testdata/HrmsTestData";
	...
	public static final String CREDENTIALS_FILEPATH = System.getProperty("user.dir")+ "/screenshot/";
	public static final String USER_NAME = null;
	public static final String OS_NAME = null;
	public static final String XL_DATA_FILEPATH = null;;
}
